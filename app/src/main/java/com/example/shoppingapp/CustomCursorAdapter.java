...
public class CustomCursorAdapter extends CursorAdapter{
    ...
    Cursor cursor;
    /*AppDatabaseHelper dh = new AppDatabaseHelper();*/
...
// TODO Auto-generated method stub
                ...
                if(cursor.moveToPosition(currentPosition))
                {
                    ...
                    if(isChecked){
                        ...
                        /*dh.(AppDatabaseHelper.USER_PASSWORD, contentValues, "_id=?", new String[]{rowID});*/

                    }else if(!isChecked){
                        contentValues.put("selected", "0");
                        /*dh.update(AppDatabaseHelper.USER_PASSWORD, contentValues, "_id=?", new String[]{rowID});*/
                    }
